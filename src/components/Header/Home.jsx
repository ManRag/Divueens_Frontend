  ...
  const slides = [
    {
      ...
      image: Image1,
      text: `
      <img src=${logo} alt="Additional Content" className="additional-image" />
        <span className="bold-text1">ELITE<span className="italic-text">Pro</span></span>
        <div className="new-line"><span className="bold-text2"> FULL ON BEAUTY, FULL ON SAVINGS!</div></span>
