...
function inputBox(props) {
  return (
    <div>
      ...
      <input type={props.type} name={props.title} id={props.title} className='inputBox w-[30vw] h-[3rem] text-[1rem] font-normal text-[#140114] p-[5px] pl-[10px] outline-0 border-[1px] border-[#474747] bg-[#fff]
