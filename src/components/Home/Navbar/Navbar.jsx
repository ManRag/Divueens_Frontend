    ...
    <nav className="navbar bg-[#fff] p-2 sticky top-0 z-[1000]">
      {isMobile ? (
        <div className="container-fluid">
          ...
          <div
            className={`offcanvas fixed top-0 right-0 h-full min-w-[20rem] w-[30%] bg-white/70 backdrop-blur-sm shadow-[-2px_0_5px_rgba(173,65,65,0.5)] p-4 translate-x-full transition-[transform] duration-[0.5s] ease-in-out ${showMenu ? "show" : ""
              }`}
          >
