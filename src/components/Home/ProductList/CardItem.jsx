            ...
            <div className='flex items-center gap-5'>
                <div className='w-full m-auto relative'>
                    <div className="m-auto bg-[#00000017] mt-[1rem] rounded-2xl">
                        <img src={Lipstick} alt='image' className='m-auto' />
                    </div>
                    <p className='text-left text-[1.3rem] font-medium leading-[1.5rem] mt-4'>Moisture Matte Long Stay
                        Lipstick - 2g | Pink Lemonade</p>
                    ...
                    <div className='flex items-center justify-between mt-1'>
                        <p className='text-[20px] mt-[6px]'>RS 500</p>
